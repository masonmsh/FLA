...
class NAIS:
    ...
    def _create_variables(self):
        with tf.name_scope("embedding"):  # The embedding initialization is unknown now
            ...
            self.h = tf.Variable(tf.ones(
                [self.weight_size, self.embedding_size]), name='H_for_MLP', dtype=tf.float32)
...
if __name__ == '__main__':
    ...
    algo = "n1-concat" if args.algorithm else "n1-prod"
